package com.example.firebase_conexion.juego;
...
import com.example.firebase_conexion.login_menu.MainActivity2;
        ...
        if(primero == null){
            ...
            if(numeroPrimero == numeroSegundo){
                ...
                if(aciertos == imagenes.length){
                    ...
                    toast.show();
                    if (puntuacion >6){
                        Intent intent=new Intent(getApplicationContext(), JuegoOferta.class);
                        startActivity(intent);
                    }
                }
            } else {
