...
import com.example.firebase_conexion.admin.LoginAdmin;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView recuperarContraseña,admin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recuperarContraseña=(findViewById(R.id.textView2));
        ...
        logear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    login.signInWithEmailAndPassword(m_email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                        @Override
        ...
        registrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    register.createUserWithEmailAndPassword(m_email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
    ...
    private void dameToastdeerror(String error) {
        ...
        switch (error) {
            ...
            case "ERROR_INVALID_EMAIL":
                Toast.makeText(MainActivity.this, "La dirección de correo electrónico está mal registrada.", Toast.LENGTH_LONG).show();
