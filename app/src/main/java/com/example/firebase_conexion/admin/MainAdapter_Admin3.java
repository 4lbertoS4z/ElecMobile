...
public class MainAdapter_Admin3 extends FirebaseRecyclerAdapter<MainModel,MainAdapter_Admin3.myViewHolder> {
    /**
     ...
     * @param options
     */
    public MainAdapter_Admin3(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
            ...
            public void onClick(View v) {
                ...
                btnActulizar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("movil_gamer").child(getRef(position).getKey()).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
        ...
        holder.btnBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference().child("movil_gamer")
