...
public class MainAdapter_Admin4 extends FirebaseRecyclerAdapter<MainModel,MainAdapter_Admin4.myViewHolder> {
    /**
     ...
     * @param options
     */
    public MainAdapter_Admin4(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
            ...
            public void onClick(View v) {
                ...
                btnActulizar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("movil_gamer_caro").child(getRef(position).getKey()).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
        ...
        holder.btnBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference().child("movil_gamer_caro")
