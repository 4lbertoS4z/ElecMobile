...
public class MainAdapter_Admin extends FirebaseRecyclerAdapter<MainModel,MainAdapter_Admin.myViewHolder> {
    /**
     ...
     * @param options
     */
    public MainAdapter_Admin(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
    }
            ...
            public void onClick(View v) {
                ...
                btnActulizar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("movil_eco").child(getRef(position).getKey()).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Borrar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("movil_eco")
